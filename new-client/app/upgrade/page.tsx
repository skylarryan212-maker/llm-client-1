...
const plans = [
  ...
  },
  {
    ...
    features: [
      "Core models (no Pro)",
      "Agents: Human Writing + limited Market/Codex access",
  ...
  },
  {
    ...
    features: [
      "Core + limited GPT-5.2 Pro access",
      "Agents: All, with higher allowances",
      "Support: Faster queue + chat",
    ],
    recommended: true,
  ...
  },
  {
    ...
    features: [
      "Core + GPT-5.2 Pro (most generous access)",
      "Agents: All, highest allowances",
      "Support: Fastest queue + direct channel",
    ],
    recommended: false,
