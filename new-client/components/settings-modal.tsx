...
export function SettingsModal({ isOpen, onClose, initialTab = 'personalization' }: SettingsModalProps) {
  ...
  return (
    <div className="modal-overlay fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm pointer-events-none">
      <div className="modal-panel relative flex flex-col sm:flex-row h-fit max-h-[90dvh] w-full max-w-[min(520px,95vw)] sm:max-w-4xl overflow-hidden rounded-xl border border-border bg-card shadow-2xl pointer-events-auto">
        {/* Sidebar */}
